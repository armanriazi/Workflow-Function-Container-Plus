...
//-----------------------Simulation
    ...
    public static  boolean ENABLE_NETWORK = false;     
...
//-----------------------Number
    ...
    //public static   int WFC_NUMBER_VMS =1;
    ...
    //public static  int  WFC_NUMBER_VM_PES_ = 10; //number of cpus
    public static  int WFC_NUMBER_HOST_PES = 10+1; //number of cpus
//-----------------------Cloudlet
...
//----------------------- VM    
    ...
    public static  int  WFC_VM_MIPS = 10000;
    public static  long WFC_VM_BW = 1000;
...
//----------------------- HOST    
    ...
    public static  long WFC_HOST_BW = 10000;
    public static  int WFC_HOST_RAM = 1024; //vm memory (MB)    
