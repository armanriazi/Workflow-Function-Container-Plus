...
import wfc.workflow.WFCParser;
import wfc.workflow.WFCEngineClustering;
...
public final class WFCPlanner extends SimEntity {
    ...
    public WFCPlanner(String name, int schedulers) throws Exception {
        super(name);
    ...
    private void processPlanning() {
        ...
        planner.setVmList(getWorkflowEngine().getAllHostList());
        try {
            planner.run();
        } catch (Exception e) {
