...
/**
 * WFCEngineClustering is an optional component of WorkflowSim and it merges tasks
 into jobs
 *
 * @author Weiwei Chen
 ...
 *
 */
public final class WFCEngineClustering extends SimEntity {
    ...
    /**
     * The WorkflowEngineId of the WFCEngine
     */
    private final int workflowEngineId;
    /**
     * The WFCEngine used in this WFCEngineClustering
     */
    private final WFCEngine workflowEngine;
     ...
     * @post $none
     */
    public WFCEngineClustering(String name, int schedulers) throws Exception {
        super(name);
        ...
        this.workflowEngine = new WFCEngine(name + "_Engine_0", schedulers);
    ...
    /**
     * Processes events available for this WFCEngineClustering.
     *
     * @pre ev != null
     * @post $none
     */
    ...
    protected void processDatastaging() {
        ...
        for (FileItem file : list) {
            /* Log.print("fffffffffffffffffffffffffffffffff=>ClusterEngine=>processDatastaging()=> files:");
             Log.printLine(file);
             Log.print("                                                                     => depth:");
    ...
    public void processEvent(SimEvent ev) {
        ...
        if(WFCConstants.CAN_PRINT_SEQ_LOG)
           Log.printLine("WFCEngineClustering=>ProccessEvent()=>ev.getTag():"+ev.getTag());
