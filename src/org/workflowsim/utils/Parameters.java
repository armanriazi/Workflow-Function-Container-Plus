...
public class Parameters {
     ...
     * CONTAINER: specify the cost per CONTAINER
     */
    public enum CostModel{
        DATACENTER(1), CONTAINER(2);
        public final int value;
    ...
    /**
     * the bandwidth from one container to one container
     */
     ...
     *
     * @param container, the number of containers
    ...
    public static void init(
            int container, String dax, String runtime, String datasize,
     ...
     */
    public static void init(
            int container, List<String> dax, String runtime, String datasize,
            OverheadParameters op, ClusteringParameters cp,
            SchedulingAlgorithm scheduler, PlanningAlgorithm planner, String rMethod,
            long dl) {
     ...
     * @param num
     */
    public static void setContainerNum(int num) {
        containerNum = num;
    }
