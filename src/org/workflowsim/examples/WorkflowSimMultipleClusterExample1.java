...
import wfc.examples.WFCExample;
import java.io.File;
...
import wfc.workflow.WFCStorageCluster;
 ...
 * @date Apr 9, 2013
 */
public class WorkflowSimMultipleClusterExample1 extends WFCExample {
    ...
    protected static WorkflowDatacenter createDatacenter(String name) {
        ...
        try {
            WFCStorageCluster s1 = new WFCStorageCluster(name, 1e12);
            switch (name) {
                case "Datacenter_0":
                    /**
