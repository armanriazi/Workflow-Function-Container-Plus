...
public class containerCloudSimTags {
     ...
     * entity.
     */
    public static final int FIND_CONTAINER_FOR_CLOUDLET = ContainerSimBASE + 1;

    /**
     * Denotes the creating a new VM is required in the data center.
     * Invoked in the data center broker.
     */
    public static final int CREATE_NEW_CONTAINER = ContainerSimBASE + 2;
    /**
     ...
     * Invoked in the data center.
     */
    public static final int CONTAINER_NEW_CREATE = ContainerSimBASE + 11;
