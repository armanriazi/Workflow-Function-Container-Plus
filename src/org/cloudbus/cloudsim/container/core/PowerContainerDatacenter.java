 ...
 */
public class PowerContainerDatacenter extends WFCDatacenter {
    ...
    protected void updateCloudletProcessing() {
        ...
        if (currentTime > getLastProcessTime()) {
            ...
            if (!isDisableVmMigrations()) {
                ...
                //by arman I commented //Log.printConcatLine(CloudSim.clock(), ": The number of Migrations is:  ", getVmMigrationCount() - previousMigrationCount);
...
//                    e.printStackTrace();
//                }
//by arman I commented                Log.printConcatLine(CloudSim.clock(),": The total number of Migrations is:  ",getVmMigrationCount());
            }
