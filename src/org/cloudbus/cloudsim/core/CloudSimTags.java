...
public class CloudSimTags {
	...
	/**
	 * Denotes a request to create a new HOST in a {@link Datacenter} with acknowledgement 
         * information sent by the Datacenter.
	 */
	public static final int HOST_CREATE = BASE + 31;

	/**
	 * Denotes a request to create a new HOST in a {@link Datacenter} 
         * with acknowledgement information sent by the Datacenter.
	 */
	public static final int HOST_CREATE_ACK = BASE + 32;

	/**
	 * Denotes a request to destroy a new HOST in a {@link Datacenter}.
	 */
	public static final int HOST_DESTROY = BASE + 33;

	/**
	 * Denotes a request to destroy a new HOST in a {@link Datacenter} 
         * with acknowledgement information sent by the Datacener.
	 */
	public static final int HOST_DESTROY_ACK = BASE + 34;

	/**
	 * Denotes a request to migrate a new HOST in a {@link Datacenter}.
	 */
	public static final int HOST_MIGRATE = BASE + 35;

	/**
	 * Denotes a request to migrate a new HOST in a {@link Datacenter}  
         * with acknowledgement information sent by the Datacener.
	 */
	public static final int HOST_MIGRATE_ACK = BASE + 36;

	/**
	 * Denotes an event to send a file from a user to a {@link Datacenter}.
	 */
	public static final int HOST_DATA_ADD = BASE + 37;

	/**
	 * Denotes an event to send a file from a user to a {@link Datacenter}
         * with acknowledgement information sent by the Datacener.
	 */
	public static final int HOST_DATA_ADD_ACK = BASE + 38;

	/**
	 * Denotes an event to remove a file from a {@link Datacenter} .
	 */
	public static final int HOST_DATA_DEL = BASE + 39;

	/**
	 * Denotes an event to remove a file from a {@link Datacenter}
         * with acknowledgement information sent by the Datacener.
	 */
	public static final int HOST_DATA_DEL_ACK = BASE + 40;

	/**
	 * Denotes an internal event generated in a {@link Datacenter}.
	 */
	public static final int HOST_DATACENTER_EVENT = BASE + 41;

	/**
	 * Denotes an internal event generated in a Broker.
	 */
	public static final int HOST_BROKER_EVENT = BASE + 42;
